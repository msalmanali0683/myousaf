...
Route::get('/app/invoice/purchase', [InvoiceAdd::class, 'purchase'])->name('app-invoice-purchase');
Route::get('/app/invoice/sale', [InvoiceAdd::class, 'sale'])->name('app-invoice-sale');
